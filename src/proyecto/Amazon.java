...
public class Amazon {
	...
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, u3.getNombreUsuario() + ", denegada tu puja por importe de 50 €");
		JOptionPane.showMessageDialog(null, s1.pujaMayor());
		s1.cerrarSubasta();
		s1.realizarPuja(u3, 200);
		JOptionPane.showMessageDialog(null, s1.pujaMayor() + " Subasta abierta: " + s1.consultarSubastaAbierta());
		JOptionPane.showMessageDialog(null,
				u3.getNombreUsuario() + ", denegada tu puja por importe de 200 €. La subasta ha sido cerrada");
